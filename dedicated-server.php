                                ...
                                <ul>
                                    ...
                                    <li class="active">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="dedicated-server.php">Dedicated server</a></li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="service-details" data-animate="fadeInUp" data-delay=".1">
                        <h2>Extreme power, flexibility and control with world’s class <span>support</span></h2>
                        ...
                        <ul class="rubik list-unstyled m-0 clearfix">
                            ...
                            <li>Supper fast speed</li>
                            <li>Pricing Lock Guarantee</li>
